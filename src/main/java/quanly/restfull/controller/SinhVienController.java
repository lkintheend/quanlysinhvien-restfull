...
public class SinhVienController {
	...
	@RequestMapping(value = "/dkh/{sinhVienId}/{monHocId}", //
			method = RequestMethod.POST, //
			produces = { MediaType.APPLICATION_JSON_VALUE })
	@ResponseBody
	public SinhVien dangKyHoc(@PathVariable("sinhVienId") int sinhVienId, @PathVariable("monHocId") int monHocId) {
		sinhVienService.dangKyHoc(sinhVienId, monHocId);
		return sinhVienService.getOne(sinhVienId);
	}
}
